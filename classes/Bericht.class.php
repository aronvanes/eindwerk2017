...
class Bericht {
  ...
  public function sendMessage() {
    ...
    $statement = $conn->prepare('INSERT INTO tbl_berichten (verzender_id, ontvanger_id, bericht, datum_verstuurd, gelezen) VALUES (:verzender_id, :ontvanger_id, :bericht, CURRENT_TIMESTAMP(), 0)');
